...
negative sampling drawn from a [BlockingStrategy][linkingtk.blocking.base.BlockingStrategy]
— see [sample_hard_negatives][linkingtk.blocking.negative_sampling.sample_hard_negatives].
"""
